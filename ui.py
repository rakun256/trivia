...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.score_label = Label(text="Score: 0", fg="white", bg=THEME_COLOR, font=("Ariel", 10, "bold"), justify="right")
        ...
        self.hanim_label = Label(text="Ecem Nur Özen 🩷", fg="white", bg=THEME_COLOR, font=("Ariel", 15, "bold"),
                                 justify="center")
        self.hanim_label.grid(column=0, row=3, columnspan=2, pady=50)
